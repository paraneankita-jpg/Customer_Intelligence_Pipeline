...
📈 Key Findings
💰 Male customers generated more than 2× the revenue of female customers — $157,890 vs. $75,191.

👥 Non-subscribers generated the majority of revenue — $170,436 vs. $62,645 from subscribers.

🛒 Average spending was almost identical for subscribers and non-subscribers — $59.49 vs. $59.87, suggesting the current subscription program is not clearly driving higher spending.

⭐ Top-rated products included Gloves (3.86), Sandals (3.84), and Boots (3.82).

🚚 Customers using Express shipping spent slightly more on average — $60.48 vs. $58.46 for Standard shipping.

❤️ Loyal customers dominate the customer base — 3,116 Loyal, 701 Returning, and 83 New customers.

🏷️ Hat, Sneakers, and Coat showed high discount dependency, with discount rates around 49–50%, creating a potential margin risk.

📦 Top-selling products included Jewelry, Blouse, Sandals, and Jacket across their respective categories.

👤 Revenue was relatively balanced across age groups, indicating that age alone is not a strong revenue differentiator.
...
Are customers with more than five purchases more likely to subscribe?
